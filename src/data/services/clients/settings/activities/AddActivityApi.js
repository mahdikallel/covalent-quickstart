...
var AddActivityApi = (function () {
    function AddActivityApi(http, basePath, configuration) {
        this.http = http;
     ...
     */
    AddActivityApi.prototype.addActivity = function (body, extraHttpRequestParams) {
     ...
     * @param body The Activity Object to create.
     */
    AddActivityApi.prototype.addActivityWithHttpInfo = function (body, extraHttpRequestParams) {
...
exports.AddActivityApi = AddActivityApi;
