...
@Injectable()
export class GetcurrentLogLevelByIdApi {
   ...
   */
  public getCurrentLogLevelById(id: number, extraHttpRequestParams?: any): Observable<models.CurrentLog> {
   ...
   * @param id The id of the currentLogLevel to retrieve
   */
  public getCurrentLogLevelByIdWithHttpInfo(id: number, extraHttpRequestParams?: any): Observable<Response> {
