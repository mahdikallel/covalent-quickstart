...
var UpdateRoleApi = (function () {
    function UpdateRoleApi(http, basePath, configuration) {
        this.http = http;
     ...
     */
    UpdateRoleApi.prototype.updateRole = function (id, body, extraHttpRequestParams) {
        return this.updateRoleWithHttpInfo(id, body, extraHttpRequestParams)
     ...
     * @param body Created Role object.
     */
    UpdateRoleApi.prototype.updateRoleWithHttpInfo = function (id, body, extraHttpRequestParams) {
