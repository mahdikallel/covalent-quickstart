...
export class UpdateRoleApi {
   ...
   */
  public updateRole(id: number, body: models.Role, extraHttpRequestParams?: any): Observable<models.Role> {
   ...
   * @param body Created Role object.
   */
  public updateRoleWithHttpInfo(id: number, body: models.Role, extraHttpRequestParams?: any): Observable<Response> {
