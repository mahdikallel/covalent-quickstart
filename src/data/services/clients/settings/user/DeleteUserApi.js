...
var DeleteUserApi = (function () {
    function DeleteUserApi(http, basePath, configuration) {
        this.http = http;
     ...
     */
    DeleteUserApi.prototype.deleteUserById = function (id, extraHttpRequestParams) {
        return this.deleteUserByIdWithHttpInfo(id, extraHttpRequestParams)
     ...
     * @param id The id of the user to delete
     */
    DeleteUserApi.prototype.deleteUserByIdWithHttpInfo = function (id, extraHttpRequestParams) {
